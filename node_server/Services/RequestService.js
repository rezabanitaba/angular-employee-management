        ...
        if(req.isAuthenticated()) {
            ...
            if(permittedRoles.length > 0) {
                ...
                if(roles.length > 0) {
                    ...
                    return { 
                        authenticated: true, username: req.user.username,
            ...
            return { 
                authenticated: true, username: req.user.username, roles: [],
                rolePermitted: rolePermitted,firstName: req.user.firstName,
                lastName: req.user.lastName,
                email: req.user.email,
                phone: req.user.phone,
                address: req.user.address
